...
export default {
  ...
  data() {
    ...
    return {
      ...
      registerformrules: {
        name: [
          { required: true, message: this.$t('valid.inputName'), trigger: "blur" },
          { required: true, message: this.$t('valid.inputName'), trigger: "change" }
        ],
        mail: [
          { required: true, message: this.$t('valid.userplaceholder'), trigger: "blur" },
          {
        ...
        shortMsgCode: [
          { required: true, message:this.$t('valid.inputCode'), trigger: "change" },
          { required: true, message: this.$t('valid.inputCode'), trigger: "blur" }
        ],
        company: [
          { required: true, message: this.$t('valid.valid002'), trigger: "blur" },
          { required: true, message: this.$t('valid.valid002'), trigger: "change" }
        ],
        isHunter: [
          { required: true, message: this.$t('valid.valid025'), trigger: "change" }
        ]
      },
